...
/** API major version */
#define VL6180x_API_REV_MAJOR   2
/** API minor version */
...
#error "VL6180x_HAVE_DMAX_RANGING not defined, likely old vl61870x_cfg.h file ?"
...
/* TODO you must define value for  VL6180x_SINGLE_DEVICE_DRIVER in your vl6180x_cfg.h */
#endif

#ifndef I2C_BUFFER_CONFIG
#error "I2C_BUFFER_CONFIG not defined"
/* TODO you must define value for  I2C_BUFFER_CONFIG in your vl6180x_cfg.h */
#endif


#ifndef  VL6180x_RANGE_STATUS_ERRSTRING
#warning "VL6180x_RANGE_STATUS_ERRSTRING not defined, likely old vl6180x_cfg.h file ?"
/* TODO you may remove or comment these #warning and keep the default below to keep compatibility
   or update your vl6180x_cfg.h file */
/**
 * force VL6180x_RANGE_STATUS_ERRSTRING to not supported when not part of cfg file
 */
...
typedef struct RangeFilterResult_tag {
    ...
    uint32_t rtnRate;       /*!< Return signal rate  related to \a RESULT_RANGE_RETURN_SIGNAL_COUNT */
    uint32_t refRate;       /*!< Reference signal signal rate related to \a RESULT_RANGE_REFERENCE_SIGNAL_COUNT */
    uint32_t rtnAmbRate;    /*!< Return Ambient rate related to \a RESULT_RANGE_RETURN_AMB_COUNT */
    uint32_t refAmbRate;    /*!< Reference Ambient rate related to \a RESULT_RANGE_REFERENCE_SIGNAL_COUNT */
...
/**
 * \weakgroup regdef Low Level Register definition
  @brief    Register level definition
 */
/**
 * The device model ID
 */
 ...
 * @brief Configures polarity and select what function  gpio 0 serves
 ...
 *
 * Possible value for Range and ALS are\n
 *
 ...
 *  @brief Write to these register clear interrupt source
 *
...
/** after power up or reset these  register will start reading 1 when device  is ready */
